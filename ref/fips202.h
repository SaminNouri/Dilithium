...
#define di_shake128_stream_init FIPS202_NAMESPACE(dishake128_init)
void di_shake128_stream_init(keccak_state *state, const uint8_t seed[SEEDBYTES], uint16_t nonce);

#define di_shake256_stream_init FIPS202_NAMESPACE(dishake256_init)
void di_shake256_stream_init(keccak_state *state, const uint8_t seed[SEEDBYTES], uint16_t nonce);
