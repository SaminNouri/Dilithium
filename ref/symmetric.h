...
//void di_shake128_stream_init(keccak_state *state,
                              //      const uint8_t seed[SEEDBYTES],
                                //    uint16_t nonce);

//#define dilithium_shake256_stream_init DILITHIUM_NAMESPACE(dilithium_shake256_stream_init)
//void di_shake256_stream_init(keccak_state *state,
...
#define stream128_init(STATE, SEED, NONCE) \
        di_shake128_stream_init(STATE, SEED, NONCE)
#define stream128_squeezeblocks(OUT, OUTBLOCKS, STATE) \
        shake128_squeezeblocks(OUT, OUTBLOCKS, STATE)
#define stream256_init(STATE, SEED, NONCE) \
        di_shake256_stream_init(STATE, SEED, NONCE)
#define stream256_squeezeblocks(OUT, OUTBLOCKS, STATE) \
